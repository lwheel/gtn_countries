...
<body>
  <div id="header">
    ...
    <div id="menu">
      <a href="https://www.globtalent.org/">Home</a> &bull;
      <div class="dropdown">
        <a href="index.html">Partner Math Olympiads</a>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="phillipines_home.html">Phillipines</a>
          <a href="india_home.html">India</a>
        </div>
      </div>
    </div>
  </div>
...
<hr>
<div id="main">
    <h2 style="color: white; font-size: 50px;">{countries}</h2>
    
<p> {countries} is not currently hosting a math olympiad.</p>

<br>
    <h2 style="color: white; font-size: 50px;">Past {adjective} Problem Sets</h2>
